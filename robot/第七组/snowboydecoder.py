...
sys.path.append('/home/pi/.local/lib/python2.7/site-packages/baidu-aip')
APP_ID = '11331887'
...
def say_hi():
    f = open('./identity/identity.txt', 'r')
    print(f.read)
    text = u'你好'+f.read()
    print(text)
    ...
    if not isinstance(result, dict):
        with open('./identity/identity.mp3', 'wb') as fr:
            fr.write(result)
    fr.close()
    pygame.mixer.init()
    track = pygame.mixer.music.load(r'./identity/identity.mp3')
